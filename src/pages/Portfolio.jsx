...
const Portfolio = () => {
    ...
    // 1. Get Content
    const content = pageContent[subcategory];
        ...
        return (
            <div className="section text-center">
                <div className="container">
                    ...
                    <p>Halaman {subcategory} belum tersedia.</p>
    ...
    return (
        <div>
            {/* Global Page Header/Hero is rendered as the first section in the data, but we can have a fallback wrapper if needed */}
